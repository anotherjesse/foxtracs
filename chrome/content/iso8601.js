...
var ISO8601DateUtils = {
  ...
  /**
  * Thunderbird's W3C-DTF function
  *
  ...
  */
  parse: function ISO8601_parse(aDateString) {
    ...
    if (!dateString.match('-')) {
      // Fix Wordpress' invalid date format
      // they use date such as 20030530T11:18:50-08:00
    ...
    // Here's an example of a W3C-DTF date string
    // and what .match returns for it.
    //
